...
class _AssetEditPageState extends State<AssetEditPage> {
  final AssetModel asset = Get.arguments['asset'] as AssetModel;
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (statusCamera.isGranted) {
      ...
      if (pickedFile != null) {
        controller.editAsset.update((asset) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: AppText.google(text: "Edit Asset", color: AppColor.white),
        backgroundColor: AppColor.blue0A1A48,
        iconTheme: IconThemeData(color: AppColor.white),
      ),
      body: Obx(() {
        List<CategoryModel> categories = controller.categories;
        FormAssetModel? editAsset = controller.editAsset.value;
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppInput.global(hintText: "Enter asset name", txtCtrl: editAsset.nameCtrl),
                    ],
                  ),
                ),
                Container(
                        ...
                        children: [
                          Flexible(
                            child: AppInput.global(
                              ...
                              txtCtrl: editAsset.categoryCtrl,
                              readOnly: true,
                              ...
                              onTapFunc: () {
                                ...
                                AppSheet.selectOneWithMapOptions(
                                    onSelectItem: ({required Map<String, Object> result}) async {
                                      ...
                                      editAsset.categoryCtrl.text = label;
                                      editAsset.categoryId = value;
                                      editAsset.categoryCode = code;
                                      Get.back();
                                    },
                                    context: context,
                                    title: "Category",
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppInput.global(
                        ...
                        txtCtrl: editAsset.conditionCtrl,
                        readOnly: true,
                        suffixIcon: AppIcon.keyboardArrowDown(),
                        onTapFunc: () {
                          AppUtil.unfocus();
                          AppSheet.selectOne(
                              onSelectItem: ({required value}) async {
                                editAsset.conditionCtrl.text = value;
                                Get.back();
                              },
                              context: context,
                              title: "Borrowable",
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppInput.global(
                        ...
                        txtCtrl: editAsset.borrowableCtrl,
                        readOnly: true,
                        suffixIcon: AppIcon.keyboardArrowDown(),
                        onTapFunc: () {
                          AppUtil.unfocus();
                          AppSheet.selectOne(
                              onSelectItem: ({required value}) async {
                                editAsset.borrowableCtrl.text = value;
                                if (value == "TRUE") {
                                  editAsset.borrowable = true;
                                } else {
                                  editAsset.borrowable = true;
                                }
                                Get.back();
                    ...
                    children: [
                      ...
                      AppInput.global(
                        ...
                        onTapFunc: () {
                          ...
                          AppSheet.selectOne(
                              onSelectItem: ({required value}) async {
                                editAsset.statusCtrl.text = value;
                                Get.back();
                              },
                              context: context,
                              title: "Conditions",
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppInput.global(
                          ...
                          txtCtrl: editAsset.purchaseDateCtrl,
                          ...
                          onTapFunc: () async {
                            ...
                            if (picked != null) {
                              editAsset.purchaseDateCtrl.text = UtilDate.formatDate(picked);
                              editAsset.purchaseDate = picked;
                            }
                          }),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      AppText.google(text: "Current Images"),
                      SizedBox(
                        height: 3.sp,
                      ),
                      editAsset.images != null && editAsset.images!.isNotEmpty
                          ? Wrap(
                              spacing: 10.sp,
                              children: [
                                for (var i = 0; i < editAsset.images!.length; i++)
                                  Container(
                                    width: 80.sp,
                                    height: 80.sp,
                                      ...
                                      child: Stack(
                                        children: [
                                          CachedNetworkImage(
                                            ...
                                            imageUrl: "${Constants.kImageAssetBaseUrl}${editAsset.images![i].path}", // Assuming `path` is a URL
                                            ...
                                            errorWidget: (context, url, error) => Center(
                                              child: Icon(AppIcon.error()), // Show an error icon if the image fails to load
                                            ),
                                          ),
                                          Align(
                                            ...
                                            child: GestureDetector(
                                              onTap: () async {
                                                // Get the assetImageId from the current image
                                                final assetImageId = editAsset.images![i].id;

                                                // Call the delete function from the controller
                                                await controller.deleteAssetImageById(assetImageId, i);
                                              },
                                              child: Icon(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        spacing: 10.sp,
                        children: [
                          for (var i = 0; i < editAsset.imagePaths.length; i++)
                            Container(
                              width: 80.sp,
                              height: 80.sp,
                              padding: EdgeInsets.all(5.sp),
                ...
                SizedBox(
                  ...
                  child: AppButton.fill(
                    text: "Save",
                    onPressed: () => controller.updateAsset(asset.id),
